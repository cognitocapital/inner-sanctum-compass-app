...
const Chapter6 = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white relative overflow-hidden">
      <PageAudioPlayer chapterId="chapter6" />
      ...
      <section className="relative w-full h-[88vh] min-h-[560px] overflow-hidden">
        ...
        <img
          src={chapter6Hero}
          alt="An empty fluorescent-lit retail aisle — sensory overload and emotional dysregulation"
          width={1920}
          height={1080}
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div className="absolute top-[34%] right-[18%] w-1 h-1 bg-amber-300 rounded-full animate-[float_7s_ease-in-out_infinite_1s] opacity-50 shadow-[0_0_10px_rgba(252,211,77,0.6)]" />
        ...
        <div className="absolute inset-0 flex flex-col justify-end pb-16 md:pb-24">
          <div className="max-w-5xl mx-auto px-6 md:px-10 w-full">
            ...
            <p className="text-white/60 text-base md:text-lg max-w-2xl font-light italic animate-[fade-in_1.6s_ease-out_0.7s_both]">
              Sensory overload, the meltdown in Kmart, and why empathy becomes a superpower.
            </p>
          </div>
        </div>
