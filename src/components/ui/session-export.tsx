...
${data.cold.moodHistory.slice(-10).map((m: number, i: number) => `  Session ${i + 1}: ${['😔 Low', '😐 Neutral', '🙂 Good', '😊 Great', '🔥 Euphoric'][m - 1] || 'N/A'}`).join('\n') || '  No mood data recorded'}
...
✓ Progressive duration limits per 2025 TBI guidelines
✓ Post-session mood tracking for dopamine response monitoring
