...
const chapters: Chapter[] = [
  ...
  { id: "introduction", title: "Introduction", audioUrl: ["/audio/introduction.mp3", "/audio/introduction-part2.mp3", "/audio/introduction-part3.mp3", "/audio/introduction-part4.mp3"] }, // Combined seamless playback
